...
export default function Footer(){return <footer className="site-footer"><div className="footer-inner">
 <div className="footer-brand"><div className="footer-logo"><img src="/media/logo-nav.svg" alt="" loading="lazy" decoding="async"/><span>D.M. MAÇONNERIE</span></div><p>Maçonnerie générale · rénovation · aménagement.<br/>Un travail soigné pour des ouvrages durables.</p></div>
