...
export default function Footer(){return <footer className="site-footer"><div className="footer-inner">
 <div className="footer-brand"><div className="footer-logo"><img src="/media/neodim-logo-main.webp" alt="" loading="lazy" decoding="async"/><span className="brand-wordmark"><b>NEO</b><strong>DIM</strong></span></div><p>Rénovation intérieure · construction · aménagement.<br/>Des espaces pensés pour durer.</p></div>
